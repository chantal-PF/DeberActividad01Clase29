...
def actualizar_estudiante():
    ...
    try:
        ...
        if 0 <= seleccion < len(estudiantes):
            ...
            print(f"Estudiante seleccionado: Nombre: {estudiante['nombre']}, Edad: {estudiante['edad']}")
...
def eliminar_estudiante():
    ...
    try:
        seleccion = int(input("Selecciona el número del estudiante que deseas eliminar: ")) - 1
        if 0 <= seleccion < len(estudiantes):
            estudiante = estudiantes.pop(seleccion)
